...
public class MessageDigestPasswordEncoder extends BaseDigestPasswordEncoder {
     ...
     * @param algorithm
     */
    public MessageDigestPasswordEncoder(final String algorithm) {
     ...
     */
    public MessageDigestPasswordEncoder(final String algorithm, final boolean encodeHashAsBase64) throws IllegalArgumentException {
