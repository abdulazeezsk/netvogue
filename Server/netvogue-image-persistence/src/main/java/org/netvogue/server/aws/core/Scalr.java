...
public class Scalr {
	...
	public static BufferedImage pad(BufferedImage src, int padding,
			BufferedImageOp... ops) throws IllegalArgumentException,
			ImagingOpException {
		return pad(src, padding, padding, Color.BLACK);
	}
	 ...
	 *             operations.
	 */
	public static BufferedImage pad(BufferedImage src, int targetWidth, int targetHeight,
		 ...
		 * image.
		 */
		int padWidthDiff  = targetWidth - srcWidth;
		int padHeightDiff = targetHeight - srcHeight;
		int newWidth = targetWidth;
		int newHeight = targetHeight;
		System.out.println("Differences" + padWidthDiff+ " " + padHeightDiff);
		if(padWidthDiff < 0)
			padWidthDiff = 0;
		if(padHeightDiff < 0)
			padHeightDiff = 0;
		if (DEBUG)
			log(0,
					"Padding Image from [originalWidth=%d, originalHeight=%d, paddingWidth=%d] to [newWidth=%d, newHeight=%d]...",
					srcWidth, srcHeight, padWidthDiff, newWidth, newHeight);
		...
		g.drawImage(src, padWidthDiff/2, padHeightDiff/2, null);
		g.dispose();
