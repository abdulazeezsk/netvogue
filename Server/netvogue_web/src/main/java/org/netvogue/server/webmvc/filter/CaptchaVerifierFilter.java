package org.netvogue.server.webmvc.filter;
...
public class CaptchaVerifierFilter extends OncePerRequestFilter {
	...
	public void doFilterInternal(HttpServletRequest req, HttpServletResponse res,
		...
		if(req.getRequestURL().toString()!=null && req.getRequestURL().toString()!=""){
			String[] urlArray = url.split("/");	
			System.out.println("after split"+urlArray[(urlArray.length -1)]);
			if(urlArray[(urlArray.length -1)].equals("Brand_Registration_Success.htm")){
				failureUrl = "/Brand_Registration.htm";
			}
