...
<body ng-app="netVogue">
    ...
    <div id="registration" class="container" ng-controller="MyCtrlRegistration">
        <div class="row">
            <div class="row">
                <legend class="subHeading">Register Boutique</legend>
                <!-- left pannel-->
                <div class="span5">
                ...
                <div class="span7 pull-left">
                    <div class="span7">
                        ...
                        <div>
                            <input type="text" id="txt_brands_carried" ng-model="brandsentered" placeholder="Enter Brand Name" 
                        ...
                        <div style="vertical-align: bottom;">
                            <button class="btn btn-primary dropdown-toggle pull-right" ng-disabled="form.$invalid"
    ...
    <script src="js/regcontroller.js" type="text/javascript"></script>s
</body>
</html>