...
function MyCtrlNetwork($scope, $routeParams, myprofile, currentvisitedprofile, srvprofile, trending) {
...
function MyCtrlCorner($scope, $routeParams, srvprofile, currentvisitedprofile, mynetwork, trending) {
    $scope.navClass = function (page1) {
        return {
            //last: this.$last,
            active: page1 && this.currentPage == page1
...
function MyCtrlPrintcampaign($scope, $routeParams, currentvisitedprofile, srvprofile) {
...
function MyCtrlVideocampaign($scope, $routeParams, currentvisitedprofile, srvprofile) {
...
function MyCtrlNewsletter($scope, $routeParams, currentvisitedprofile, srvprofile) {
...
function MyCtrlCollections($scope, $routeParams, currentvisitedprofile, srvprofile) {
...
function MyCtrlLinesheets($scope, $routeParams, currentvisitedprofile, srvprofile) {
    ...
    $scope.linesheets = [
	                   {
	                       ...
	                       "linesheetcoverpic": "http://placehold.it/50x50"
    ...
    $scope.stylethumbnails = [
	                   {
	                       ...
	                       "stylethumbnail": "http://placehold.it/75x90"
    ...
    $scope.styletdetails =
	                   {
	                       ...
	                       "stylesize": "S M L XL",
	                       "styleprice": "12000",
	                       "stylecover": "http://placehold.it/75x90"
	                   }
    ...
    $scope.styles = [
	                   {
	                       ...
	                       "styledeliverydate": "25/04/2012",
	                       "styleprice": "5000",
	                       "stylecoverpic": "http://placehold.it/50x50"
...
function MyCtrlPrivacySettings($scope, $routeParams, currentvisitedprofile, srvprofile) {
...
function MyCtrlOrganizestyle($scope, $routeParams, currentvisitedprofile, srvprofile) {
...
function MyCtrlNotifications($scope, $routeParams, currentvisitedprofile, srvprofile) {
